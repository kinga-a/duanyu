...
<body>
    <div class="container">
        ...
        <div style="text-align: center; margin-top: 20px;">
            ...
            <a href="https://github.com/kinga-a/duanyu" target="_blank" style="color: #667eea; text-decoration: none; display: inline-flex; align-items: center; gap: 6px;">
  <svg height="15" viewBox="0 0 15 15" version="1.1" width="15" aria-hidden="true" fill="currentColor">
